...
from poco_model import PocoModel
from base.nn import count_parameters
...
class PPSurfNetwork(pl.LightningModule):
    ...
    def __init__(self, in_channels, latent_size, out_channels, k, num_pts_local, pointnet_latent_size):
        ...
        from poco_model import InterpAttentionKHeadsNet
        from base.nn import FKAConvNetwork
        from base.nn import PointNetfeat, MLP
