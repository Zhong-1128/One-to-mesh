...
from occupancy_data_module import OccupancyDataModule, get_training_data_dir
from base.container import dict_np_to_torch
...
def sampling_quantized(pts_batch, ratio=None, n_support=None, support_points=None, support_points_ids=None):
    ...
    from base.nn import batch_gather
