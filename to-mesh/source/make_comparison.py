...
import base.visualization
import occupancy_data_module
...
def comparison_rec_mesh_template(args):
    ...
    from occupancy_data_module import read_shape_list
    ...
    base.visualization.render_meshes(all_meshes_in, all_renders_out, workers=args.workers)
